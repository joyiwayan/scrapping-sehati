   ...
   if amount_pagination_current_page == 12:
      ...
      for e in range(0, int(amount_pagination_current_page), 1):
         ...
         if e+1 != 1 and e % 10 != 0:
            ...
            btn_page_next_click = WebDriverWait(driver, 100).until(ec.element_to_be_clickable((By.XPATH,f"//table[@id='GridView3']/tbody/tr[@class='GridPager']/td/table/tbody/tr/td/a[contains(@href,'{e+1}')]")))
            driver.execute_script("arguments[0].click();", btn_page_next_click)
            time.sleep(3)
            driver.implicitly_wait(60)
            print('')
